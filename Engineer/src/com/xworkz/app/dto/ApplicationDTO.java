	...
	public boolean equals(Object obj) {
		if (obj != null) {
			if (obj instanceof ApplicationDTO) {
				...
				if (applicationDTO.id == id && applicationDTO.name.equals(name)
						&& applicationDTO.developedBy.equals(developedBy)
						&& applicationDTO.developedAt.equals(developedAt) && applicationDTO.version.equals(version)) {
					return true;
				}
			}
		}
